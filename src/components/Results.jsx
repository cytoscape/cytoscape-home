...
const Card = ({ logo, title, url, caption, isLoading, error, children, className }) => (
  <div className={`w-full p-4 rounded-xl shadow-lg shadow-gray-200 ${error ? 'border-double border-4 border-red-100' : 'border border-gray-200'} ${className}`}>
            ...
            >
              <DialogPanel className="flex flex-col w-full h-full text-left transition-all px-0">
                <div className="flex-initial md:px-4 px-2 md:pb-0 pb-2 bg-white border-b border-gray-200 drop-shadow-md">
                  <div className="flex flex-row sm:items-start items-center lg:space-x-10 md:space-x-6 space-x-4 xl:max-w-7xl mx-auto md:pt-5 pt-2 text-gray-400">
                    <a
                      aria-label="Home"
                      onClick={onClose}
