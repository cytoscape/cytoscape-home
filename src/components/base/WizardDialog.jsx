      ...
      <Dialog className="relative z-10" onClose={() => void 0/**(make it modal)*/}>
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-0 text-center sm:items-center sm:p-4">
            ...
            >
              <DialogPanel className="relative transform overflow-hidden w-full rounded-t-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:max-w-lg sm:p-6 sm:rounded-lg">
